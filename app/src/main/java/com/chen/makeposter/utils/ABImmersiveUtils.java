package com.chen.makeposter.utils;
...
public class ABImmersiveUtils {
    ...
    public static boolean isImmersive(Activity activity){
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            boolean isWindowDrawSystemBarBackground = (activity.getWindow().getAttributes()
                    .flags & WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS)
                    == WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS ;

            boolean isLayoutFullScreen = (activity.getWindow().getDecorView()
                    .getSystemUiVisibility() & View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN)
                    == View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN ;


            boolean isLayoutStable = (activity.getWindow().getDecorView()
                    .getSystemUiVisibility() & View.SYSTEM_UI_FLAG_LAYOUT_STABLE)
                    == View.SYSTEM_UI_FLAG_LAYOUT_STABLE ;

            return isWindowDrawSystemBarBackground && isLayoutFullScreen && isLayoutStable ;

        } else if (Build.VERSION.SDK_INT >= 19) {


            boolean isTranslucentStatus = (activity.getWindow().getAttributes()
