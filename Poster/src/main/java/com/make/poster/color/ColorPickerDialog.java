...
import com.make.poster.color.listeners.ColorListener;
import com.make.poster.color.listeners.ColorPickerViewListener;
import com.make.poster.color.preference.ColorPickerPreferenceManager;
...
public class ColorPickerDialog extends AlertDialog {
  ...
  public static class Builder extends AlertDialog.Builder {
    ...
    private void onCreate() {
      ...
      this.colorPickerView.attachAlphaSlider((AlphaSlideBar) parentView.findViewById(R.id.AlphaSlideBar));
